...
wget "https://raw.githubusercontent.com/theshoqanebi/cxxdroid-libraries-free/main/allegro-${archurl}.tar.xz" -O "/data/user/0/ru.iiec.cxxdroid/app_HOME/allegro-${archurl}.tar.xz" >/dev/null 2>&1
printf "\e[32m%s\n" "Done"
